...
<html>
    <head>
        ...
        <link href="<?php echo base_url(); ?>vendor/_default/mincss/entireframework.min.css" rel="stylesheet" type="text/css">
        <link href="<?php echo base_url(); ?>vendor/_default/mincss/welcome.css" rel="stylesheet" type="text/css">
    </head>
    <body>
